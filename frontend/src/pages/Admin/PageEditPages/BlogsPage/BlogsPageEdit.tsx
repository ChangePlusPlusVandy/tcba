    ...
    <div className='flex min-h-screen bg-gray-50'>
      ...
      <div className='flex-1 p-8'>
        <div className='max-w-4xl mx-auto'>
          <div className='mb-8'>
            <h1 className='text-3xl font-bold text-gray-900 mb-2'>Edit Blogs Page</h1>
            <p className='text-gray-600'>Manage the header content displayed on the Blogs page</p>
          </div>
            ...
            <div className='fixed inset-0 z-50 flex items-center justify-center bg-black/30 p-4'>
              <div className='bg-white rounded-lg w-full h-full overflow-hidden flex flex-col'>
                <div className='flex items-center justify-between p-4 border-b bg-white sticky top-0 z-10'>
                  <h2 className='text-xl font-bold text-gray-900'>Preview: Blogs Page</h2>
                  <button
                ...
                <div className='overflow-y-auto overflow-x-hidden flex-1 bg-white'>
                  <BlogsPage previewContent={content} />
                </div>
              </div>
            </div>
          )}
