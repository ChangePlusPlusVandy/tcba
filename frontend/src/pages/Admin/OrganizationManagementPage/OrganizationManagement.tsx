              ...
              <div className='flex gap-2'>
                <button
                  ...
                  className={`px-6 py-2.5 rounded-[10px] font-medium transition ${
                    filter === 'ALL'
                      ? 'bg-[#D54242] text-white border border-[#D54242]'
            ...
            <>
              ...
              <div className='flex justify-end mt-6'>
                <button
                  ...
                  className='flex items-center gap-2 px-6 py-2.5 rounded-[10px] font-medium transition bg-white text-[#D54242] border border-[#D54242] hover:bg-[#D54242] hover:text-white disabled:bg-gray-300 disabled:text-gray-500 disabled:border-gray-300 disabled:cursor-not-allowed'
                >
