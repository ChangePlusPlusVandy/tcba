    ...
    <div className="fixed inset-0 backdrop-blur-sm bg-gray-900/20 flex items-center justify-center z-50 p-4">
      <div className="bg-white rounded-2xl shadow-2xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-gray-900 font-medium">{format(new Date(event.startTime), 'EEEE, MMMM d, yyyy')}</p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-gray-900 font-medium">{format(new Date(event.startTime), 'h:mm a')}</p>
              </div>
            </div>
        ...
        <div className="mx-8 mt-6 bg-blue-100 border border-blue-200 rounded-xl p-4 flex items-start gap-3">
          ...
          <p className="text-blue-900 text-sm">We'll send you event details and reminders via email</p>
        </div>
